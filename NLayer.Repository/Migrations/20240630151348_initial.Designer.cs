...
namespace NLayer.Repository.Migrations
{
    ...
    [Migration("20240630151348_initial")]
            ...
            modelBuilder.Entity("NLayer.Core.Model.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            DateTime = new DateTime(2024, 6, 30, 18, 13, 47, 806, DateTimeKind.Local).AddTicks(2963),
                            Name = "Kalem 1",
                            Price = 100m,
                            Stock = 20
                        },
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            DateTime = new DateTime(2024, 6, 30, 18, 13, 47, 806, DateTimeKind.Local).AddTicks(2970),
                            Name = "Kalem 2",
                            Price = 120m,
                            Stock = 200
                        },
                        new
                        {
                            Id = 3,
                            CategoryId = 1,
                            DateTime = new DateTime(2024, 6, 30, 18, 13, 47, 806, DateTimeKind.Local).AddTicks(2971),
                            Name = "Kalem 3",
                            Price = 150m,
                            Stock = 25
                        },
                        new
                        {
                            Id = 4,
                            CategoryId = 2,
                            DateTime = new DateTime(2024, 6, 30, 18, 13, 47, 806, DateTimeKind.Local).AddTicks(2972),
                            Name = "Kitap 1",
                            Price = 400m,
                            Stock = 30
                        },
                        new
                        {
                            Id = 5,
                            CategoryId = 2,
                            DateTime = new DateTime(2024, 6, 30, 18, 13, 47, 806, DateTimeKind.Local).AddTicks(2973),
                            Name = "Kitap 2",
                            Price = 200m,
                            Stock = 10
                        });
